      ...
      <div className="text-center dark-color">
        <div className = "center-place">
          ...
          <div className="dark-color">
            ...
            <h4 className="text-light">Your Student/User account has been successfully created.</h4>
            <Link to= "/sign_user" className="btn btn-lg btn-success">Continue &raquo;</Link>
          </div>
